  ...
  return (
    <>
      <div style={{
        ...
        zIndex: 9999, pointerEvents: "none", background: "rgba(10,10,10,0.08)",
      }}>
        <div style={{
      ...
      <button
        ...
        onMouseEnter={(e) => { e.currentTarget.style.opacity = atBottom ? "0.7" : "0"; }}
        onMouseLeave={(e) => { e.currentTarget.style.opacity = atBottom ? "1" : "0"; }}
      >
